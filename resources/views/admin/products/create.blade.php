          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="sku" id="sku" placeholder="SKU"
                  class="form-control" value="{{ old('sku') }}" required>
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" name="price" id="price" placeholder="Price"
                  class="form-control" value="{{ old('price') }}" required step="0.01">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" name="discount" id="discount" placeholder="Discount"
                  class="form-control" value="{{ old('discount') }}" step="0.01">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" name="purchase_price" id="purchase_price" placeholder="Purchase Price"
                  class="form-control" value="{{ old('purchase_price') }}" required step="0.01">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="number" name="quantity" id="quantity" placeholder="Quantity"
                  class="form-control" value="{{ old('quantity') }}" required min="0">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="date" name="expire_date" id="expire_date" placeholder="Expire Date"
                  class="form-control" value="{{ old('expire_date') }}">
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="file" name="product_image" id="product_image" class="basic-filepond" accept="image/*">
