...
namespace Xenon\LaravelBDSms\Facades {
    ...
    class SMS {
         ...
         * @static 
         */
        public static function via($provider)
        {
            /** @var \Xenon\LaravelBDSms\SMS $instance */
            return $instance->via($provider);
        }
         ...
         * @static 
         */
        public static function shoot($number, $text)
        {
            /** @var \Xenon\LaravelBDSms\SMS $instance */
            return $instance->shoot($number, $text);
        }
         ...
         * @static 
         */
        public static function shootWithQueue($number, $text, $queueName = 'default', $tries = 3, $backoff = 60)
        {
            /** @var \Xenon\LaravelBDSms\SMS $instance */
            return $instance->shootWithQueue($number, $text, $queueName, $tries, $backoff);
        }
...
namespace  {
    ...
    class SMS extends \Xenon\LaravelBDSms\Facades\SMS {}
    class LaravelBDSms extends \Xenon\LaravelBDSms\Facades\SMS {}
